...
public class RandomNameUtil {
     ...
     * @Description: 随机取名字
     */
    public static String randomChineseName(boolean simple, int len) {
        String[] surName = {
    ...
    /**
     * 单复姓随机，长度为单姓2-3，复姓3-4
     * @return
     */
    public static String randomChineseName() {
        Random random = new Random();
        int r = random.nextInt(2);
        boolean simple = r == 0;    //0为单姓，1为复姓

        int nameLen = random.nextInt(2) + 2 + r;

        return randomChineseName(simple, nameLen);
    }
}
