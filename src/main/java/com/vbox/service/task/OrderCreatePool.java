    ...
    private void asyncOrder(POrderQueue po) throws Exception {
        ...
        if (orderResp != null && orderResp.get("data") != null) {
            if (orderResp.getInteger("code") != 1) {
                ...
                pOrderMapper.updateInfoForQueue(orderId, randomACInfo.getAcid(), OrderStatusEnum.NO_PAY.getCode(), platform_oid, payUrl, payIp, asyncTime);
